...
public class CamperTest extends DSL {
	...
	@Test
	public void camperDevePreencherEnviarFormulario() {
		...
		setRightHandDrive(righHandDrive);
		setFuel(fuel);
		setPayload(payload);
		...
		assertEquals(righHandDrive,obterTextoEscrito(getRightHandDriveYes()));
