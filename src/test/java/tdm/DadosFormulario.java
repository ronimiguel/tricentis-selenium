...
public class DadosFormulario {
	...
	public static final String zipcode = "11232";
	public static final String city = "New York";
	public static final String occupation = "Farmer";
	...
	public static final String optionalEuro = "Euro Protection";
	public static final String optionalLegal = "Legal Defense Insurance";
	public static final String cortesyYes = "Yes";
	public static final String courtesyNor = "No";
	...
	public static final String email = "josemaria@gmail.com";
	public static final String phone = "43243240011";
	public static final String userName = "josemaria";
	public static final String password = "Bologne1";
	public static final String confirmPassword = "Bologne1";
	public static final String comments = "Make it cheap!";
}
